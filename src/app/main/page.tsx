      ...
      <main className="relative min-h-screen overflow-hidden px-4 py-8 sm:px-8">
        ...
        <div className="relative mx-auto grid w-full max-w-[1400px] gap-6">
          ...
          <section className="rounded-[2rem] border border-white/20 bg-white/10 p-6 shadow-2xl backdrop-blur-2xl">
            ...
            <h2 className="mt-2 text-2xl font-semibold text-white">Create New, Then Monitor Tasks</h2>
            <p className="mt-2 text-sm text-white/75">
              Use Create New for creation and scheduling. Use Tasks for scheduled/live/finished execution status.
            </p>
            <div className="mt-5 flex flex-wrap gap-3">
              <Link
                href="/items"
                className="brand-push-btn inline-flex items-center px-4 py-2 text-sm font-medium"
              >
                Create New
              </Link>
              <Link
                href="/tasks"
                className="brand-push-btn-ghost inline-flex items-center px-4 py-2 text-sm font-medium"
              >
                Tasks
              </Link>
            </div>
